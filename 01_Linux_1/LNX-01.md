...
### Resultaat
Het is gelukt om de verbinding te maken in Powershell met Openssh. Zie output ***whoami***
![LNX-01 screenshot](https://github.com/kaman-codes/techgrounds-kaman/blob/main/00_includes/LNX-01 screenshot.PNG)
